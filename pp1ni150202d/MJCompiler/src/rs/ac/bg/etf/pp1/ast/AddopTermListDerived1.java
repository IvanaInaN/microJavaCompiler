...
public class AddopTermListDerived1 extends AddopTermList {

    private AddopTermList AddopTermList;
    private AddopTerm AddopTerm;

    public AddopTermListDerived1 (AddopTermList AddopTermList, AddopTerm AddopTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AddopTermListDerived1(\n");
