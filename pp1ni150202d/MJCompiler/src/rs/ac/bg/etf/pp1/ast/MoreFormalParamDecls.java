...
public class MoreFormalParamDecls extends FormPars {

    private FormPars FormPars;
    private FormalParamDecl FormalParamDecl;

    public MoreFormalParamDecls (FormPars FormPars, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MoreFormalParamDecls(\n");
