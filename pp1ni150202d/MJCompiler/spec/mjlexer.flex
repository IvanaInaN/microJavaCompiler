...
"numconst" 		{return new_symbol(sym.NUMCONST , yytext());}
"charconst" 	{return new_symbol(sym.CHARCONST , yytext());}
"boolconst" 	{return new_symbol(sym.BOOLCONST , yytext());}
...
"True"|"False"|"true"|"false"|"TRUE"|"FALSE"	{ return new_symbol(sym.BOOLCONST, yytext()); }
[0-9]+	{ return new_symbol(sym.NUMCONST, new Integer (yytext())); }
\'([a-z]|[A-Z]|[0-9])\'	{ return new_symbol(sym.CHARCONST, new Character(yytext().charAt(1))); }
